...
Ваш вариант:
Добавьте к существующим операциям replace <strA> <strB>, которая меняет подстроку <strA> на подстроку <strB> в строках, которые приходят на вход
Строки <strA> и <strB> не допускают пробелов
